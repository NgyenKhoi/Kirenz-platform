      ...
      <div className="bg-surface text-on-surface min-h-screen selection:bg-primary-container selection:text-on-primary-container pb-20 md:pb-0">
        ...
        <header className="flex justify-between items-center px-6 py-4 w-full sticky top-0 z-50 bg-surface/80 backdrop-blur-md shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-primary truncate">Privacy & Safety</h2>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
          <header className="mb-8">
            <h2 className="text-3xl font-bold text-primary mb-2 tracking-tight">Privacy & Safety</h2>
            <p className="text-base font-medium text-on-surface-variant">Manage who can see your moments and how you interact with the community.</p>
          </header>
